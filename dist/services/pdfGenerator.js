...
const WHITE = '#ffffff';
// ─── Helpers ─────────────────────────────────────────────────────────────────
function formatPeriod(start, end, type) {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (report.workerBreakdown.length > 0) {
            ...
            const workerCols = [
                ...
                { text: 'Worker Name', width: W - 100, align: 'left', bold: true, color: WHITE },
                { text: 'Submissions', width: 70, align: 'right', bold: true, color: WHITE },
            ];
